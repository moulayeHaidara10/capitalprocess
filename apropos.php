...
================================================== -->
  <meta charset="utf-8">
  <title>Capital process - A propos</title>
          ...
          <div id="page-slider" class="page-slider small-bg">
              ...
              <div class="item" style="background-image:url(images/slider-pages/slide-page2.jpg)">
                <div class="container">
                    <div class="box-slider-content">
                      <div class="box-slider-text">
                          <h2 class="box-slide-title">Relations</h2>
                      </div>    
                    </div>
                </div>
              </div><!-- Item 1 end -->
...
<section id="ts-team" class="ts-team">
  <div class="container">
    <div class="row text-center">
        <div class="col-lg-12">
          <h2 class="section-title">Service de Qualite</h2>
          <h3 class="section-sub-title">Equipe Professionnel</h3>
        </div>
    </div><!--/ Title row end -->
          ...
          <div id="team-slide" class="team-slide">
              <div class="item">
                <div class="ts-team-wrapper">
                    ...
                    <div class="ts-team-content">
                      <h3 class="ts-name">Arnaud Kouassi</h3>
                      <p class="ts-designation">Chef projet</p>
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    ...
                    <div class="ts-team-content">
                      <h3 class="ts-name">Roxane Gnamien</h3>
                      <p class="ts-designation">PCA</p>
                      <p class="ts-description">Nats Stenman began his career in construction with boots on the ground</p>
                      <div class="team-social-icons">
                          <a target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
                          <a target="_blank" href="#"><i class="fab fa-twitter"></i></a>
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    ...
                    <div class="ts-team-content">
                      <h3 class="ts-name">Karim Konate</h3>
                      <p class="ts-designation">DGA</p>
                      <p class="ts-description">Nats Stenman began his career in construction with boots on the ground</p>
                      <div class="team-social-icons">
                          <a target="_blank" href="#"><i class="fab fa-twitter"></i></a>
                          <a target="_blank" href="#"><i class="fab fa-google-plus"></i></a>
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    ...
                    <div class="ts-team-content">
                      <h3 class="ts-name">N'GOM Nathalie</h3>
                      <p class="ts-designation">DG</p>
                      <p class="ts-description">Nats Stenman began his career in construction with boots on the ground</p>
                      <div class="team-social-icons">
                          <a target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
                          <a target="_blank" href="#"><i class="fab fa-twitter"></i></a>
